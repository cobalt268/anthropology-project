...
\newcommand{\cardtypenerf}[1]{\cardtype{characterbg}{#1}{\hspace{-1mm}\LARGE\lefthand}{Nerf}}
\newcommand{\cardtypedefense}[1]{\cardtype{abilitybg}{#1}{\hspace{-1mm}\Large\floweroneright}{Defense}}
\newcommand{\cardtypeboost}[1]{\cardtype{testbg}{#1}{\hspace{-1.4mm}\huge\ding{78}}{Boost}}
